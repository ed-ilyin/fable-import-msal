...
MacOS/Linux | Windows
--- | ---
[![Travis Badge](https://travis-ci.org/MyGithubUsername/Fable.Import.Msal.svg?branch=master)](https://travis-ci.org/MyGithubUsername/Fable.Import.Msal) | [![Build status](https://ci.appveyor.com/api/projects/status/github/MyGithubUsername/Fable.Import.Msal?svg=true)](https://ci.appveyor.com/project/MyGithubUsername/Fable.Import.Msal)
[![Build History](https://buildstats.info/travisci/chart/MyGithubUsername/Fable.Import.Msal)](https://travis-ci.org/MyGithubUsername/Fable.Import.Msal/builds) | [![Build History](https://buildstats.info/appveyor/chart/MyGithubUsername/Fable.Import.Msal)](https://ci.appveyor.com/project/MyGithubUsername/Fable.Import.Msal)
...
Stable | Prerelease
--- | ---
[![NuGet Badge](https://buildstats.info/nuget/Fable.Import.Msal)](https://www.nuget.org/packages/Fable.Import.Msal/) | [![NuGet Badge](https://buildstats.info/nuget/Fable.Import.Msal?includePreReleases=true)](https://www.nuget.org/packages/Fable.Import.Msal/)
